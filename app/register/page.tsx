...
export default function RegisterPage() {
    ...
    return (
        <div className="w-full lg:grid lg:min-h-screen lg:grid-cols-2 bg-background text-foreground selection:bg-primary/20 selection:text-primary">
            ...
            {/* Left Column: The Register Form */}
            <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 min-h-screen lg:min-h-0 relative z-10">

                {/* Mobile Background Elements (hidden on lg) */}
                <div className="lg:hidden absolute inset-0 pointer-events-none z-0">
                    <div className="absolute top-0 left-0 w-[300px] h-[300px] rounded-full bg-primary/5 blur-[50px] -translate-y-1/2 -translate-x-1/4" />
                ...
                <div className="mx-auto flex w-full flex-col justify-center space-y-8 max-w-[400px] relative z-10">
                        ...
                        />
                            ...
                            />
                                ...
                                <div className={`transition-all duration-300 overflow-hidden ${password.length > 0 ? 'h-[28px] opacity-100 mt-1' : 'h-0 opacity-0'}`}>
                                    ...
                                    <div className="flex items-center gap-1.5 mt-1.5 justify-end text-[10px] text-muted-foreground uppercase tracking-widest font-mono">
                                        <ShieldCheck className={`w-3 h-3 ${strength >= 4 ? 'text-primary' : 'text-muted-foreground'} transition-colors duration-300`} />
                                        <span>
                    ...
                    <div className="text-center text-sm text-muted-foreground mt-4">
                        ...
                        <Link href="/login" className="text-foreground hover:text-primary font-medium transition-colors underline underline-offset-4 decoration-border hover:decoration-primary">
                            Sign in
                        </Link>
                    </div>
            ...
            <div className="hidden lg:flex flex-col justify-between bg-muted/30 p-10 xl:p-14 relative overflow-hidden border-r border-border">
                ...
                <div className="relative z-10 max-w-lg mt-auto ml-auto text-right">
                    ...
                    <blockquote className="space-y-4">
                        ...
                        <footer className="text-sm">
                            ...
                            <div className="text-muted-foreground">Frontend Lead, Nexus</div>
                        </footer>
                    </blockquote>
                </div>
            </div>
