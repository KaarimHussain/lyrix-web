      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center overflow-hidden border-b border-border/50 pb-16">
        ...
        <div className="container px-4 md:px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link href="/features/lyrix-ai/chat">
              <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl h-12 px-8 font-semibold transition-all w-full sm:w-auto">
